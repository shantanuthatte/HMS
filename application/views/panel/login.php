...
<div id="main_container">
    ...
    <div class="logo">HMS<p>Hospital Management System</p></div>
         ...
         <div class="login_form" id="forgot-form">
         
         <h3>Forgot Password</h3>
         
         <a href="#" class="forgot_pass" id="show-login">Login</a> 
    ...
    <div class="footer_login">
    	...
    	<div class="left_footer_login">&copy; 2012, Sharad Consultants.</a></div>
    	<div class="right_footer_login"><a href=""><img src="" alt="" title="" border="0" /></a></div>
