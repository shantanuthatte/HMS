...
<script type="text/javascript" src="http://code.jquery.com/jquery.min.js"></script>
   ...
   <img src="images/medical_kit.svg" width="550" height="316"  alt="baner">
   </div>
   
   <header class="group_bannner_left">
   <hgroup>
   <h1>Patients.Doctors</h1>
   <h2>"And nothing in between." 
   </h2>
   </hgroup>
   </header>
   </div>
   ...
   <footer>
   <div class="container">  
   <div id="FooterTwo"> &copy; 2012, Sharad Consultants </div>
   <div id="FooterTree"> Best viewed in Chrome 20+, Firefox 15+ or any other modern browser. </div> 
   </div>
   </footer>
   <!--end footer-->
